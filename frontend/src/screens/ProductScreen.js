			...
			{loading ? (
				...
				<>
					...
					<Row>
						...
						<Col md={6}>
							<ListGroup variant='flush'>
								...
								<ListGroup.Item>
									<p>Disponible: {product.countInStock}</p>
					...
					<Row className='review-section'>
						<Col md={6}>
							<h2 className='show-review'>Reseñas de productos</h2>
											...
											<ListGroup>
												<ListGroup.Item>
													...
													{userInfo ? (
														...
														<Message>
															Por favor <Link to='/login'>inicia sesión</Link> para escribir una
															reseña{' '}
														</Message>
													)}
												</ListGroup.Item>
