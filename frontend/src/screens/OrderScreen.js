...
const OrderScreen = ({ match, history }) => {
	...
	return loading ? (
		...
		<>
			<h1 className='order-id'>Orden {order._id}</h1>
			<Row>
				<Col md={8}>
					<ListGroup variant='flush'>
						<ListGroup.Item className='item-section'>
							<h2 className='item-header' style={{ color: 'white' }}>
								Artículos
							</h2>
						...
						<Row className='shipping-section'>
							<Col>
								<ListGroup.Item>
									<h2 className='shipping' style={{ color: 'white' }}>
										Datos de envío
									</h2>
									<p>
									...
									{order.isDelivered ? (
										<Message variant='success'>Entregado en {order.deliveredAt}</Message>
									) : (
							...
							<Col>
								<ListGroup.Item>
									<h2 className='payment' style={{ color: 'white' }}>
										Información de pago
									</h2>
									<p>
